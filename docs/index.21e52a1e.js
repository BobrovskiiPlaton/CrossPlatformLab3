class t {
    constructor() {
        let t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : "https://api.spacexdata.com/v4/";
        this.baseUrl = t
    }
    launches() {
        return fetch(`${this.baseUrl}launches`).then((t => t.json()))
    }
    launchpads() {
        return fetch(`${this.baseUrl}launchpads`).then((t => t.json()))
    }
    launchpad(t) {
        return fetch(`${this.baseUrl}launchpads/${t}`).then((t => t.json()))
    }
}
var e = {
    value: () => {}
...
function n() {
    for (var t, e = 0, n = arguments.length, o = {}; e < n; ++e) {
        if (!(t = arguments[e] + "") || t in o || /[\s.]/.test(t)) throw new Error("illegal type: " + t);
        o[t] = []
    }
    return new r(o)
}
...
function a(t, n, r) {
    for (var o = 0, i = t.length; o < i; ++o)
        if (t[o].name === n) {
            t[o] = e, t = t.slice(0, o).concat(t.slice(o + 1));
            break
...
r.prototype = n.prototype = {
    ...
    on: function(t, e) {
        ...
        if (!(arguments.length < 2)) {
            ...
            for (; ++s < l;)
                if (n = (t = u[s]).type) r[n] = a(r[n], t.name, e);
                else if (null == e)
                for (n in r) r[n] = a(r[n], t.name, null);
            return this
        }
        for (; ++s < l;)
            if ((n = (t = u[s]).type) && (n = i(r[n], t.name))) return n
    },
    copy: function() {
        var t = {},
            e = this._;
...
function M(t, e, n, r, o, i) {
    for (var a, u = 0, s = e.length, l = i.length; u < l; ++u)(a = e[u]) ? (a.__data__ = i[u], r[u] = a) : n[u] = new F(t, i[u]);
    for (; u < s; ++u)(a = e[u]) && (o[u] = a)
}
...
function S(t, e, n, r, o, i, a) {
    var u, s, l, p = new Map,
        ...
        y = i.length,
        f = new Array(c);
    for (u = 0; u < c; ++u)(s = e[u]) && (f[u] = l = a.call(s, s.__data__, u, e) + "", p.has(l) ? o[u] = s : p.set(l, s));
    for (u = 0; u < y; ++u) l = a.call(t, i[u], u, i) + "", (s = p.get(l)) ? (r[u] = s, s.__data__ = i[u], p.delete(l)) : n[u] = new F(t, i[u]);
    for (u = 0; u < c; ++u)(s = e[u]) && p.get(f[u]) === s && (o[u] = s)
}
...
function K(t, e) {
    for (var n = j(t), r = -1, o = e.length; ++r < o;) n.add(e[r])
}

function Y(t, e) {
    for (var n = j(t), r = -1, o = e.length; ++r < o;) n.remove(e[r])
}
...
function Z(t, e) {
    return function() {
        (e.apply(this, arguments) ? K : Y)(this, t)
    }
}
...
function it(t) {
    return function() {
        var e = this.ownerDocument,
            n = this.namespaceURI;
        return "http://www.w3.org/1999/xhtml" === n && "http://www.w3.org/1999/xhtml" === e.documentElement.namespaceURI ? e.createElement(t) : e.createElementNS(n, t)
    }
}
    ...
    return function() {
        ...
        if (o)
            for (var a = 0, u = o.length; a < u; ++a)
                if ((r = o[a]).type === t.type && r.name === t.name) return this.removeEventListener(r.type, r.listener, r.options), this.addEventListener(r.type, r.listener = i, r.options = n), void(r.value = e);
...
_t.prototype = wt.prototype = {
    ...
    select: function(t) {
        ...
        for (var e = this._groups, n = e.length, r = new Array(n), o = 0; o < n; ++o)
            for (var i, a, u = e[o], s = u.length, l = r[o] = new Array(s), p = 0; p < s; ++p)(i = u[p]) && (a = t.call(i, i.__data__, p, u)) && ("__data__" in i && (a.__data__ = i.__data__), l[p] = a);
    ...
    selectAll: function(t) {
        ...
        for (var e = this._groups, n = e.length, r = [], o = [], i = 0; i < n; ++i)
            for (var a, u = e[i], s = u.length, l = 0; l < s; ++l)(a = u[l]) && (r.push(t.call(a, a.__data__, l, u)), o.push(a));
        return new _t(r, o)
    },
    ...
    selectChildren: function(t) {
        return this.selectAll(null == t ? w : function(t) {
            return function() {
    ...
    filter: function(t) {
        ...
        for (var e = this._groups, n = e.length, r = new Array(n), o = 0; o < n; ++o)
            for (var i, a = e[o], u = a.length, l = r[o] = [], p = 0; p < u; ++p)(i = a[p]) && t.call(i, i.__data__, p, a) && l.push(i);
        return new _t(r, this._parents)
    },
    data: function(t, e) {
        ...
        for (var i = o.length, a = new Array(i), u = new Array(i), s = new Array(i), l = 0; l < i; ++l) {
            var p = r[l],
                c = o[l],
                y = c.length,
                f = x(t.call(p, p && p.__data__, l, r)),
                h = f.length,
                d = u[l] = new Array(h),
                g = a[l] = new Array(h),
                m = s[l] = new Array(y);
            n(p, c, d, g, m, f, e);
            for (var v, _, w = 0, P = 0; w < h; ++w)
                if (v = d[w]) {
                    for (w >= P && (P = w + 1); !(_ = g[P]) && ++P < h;);
                    v._next = _ || null
                }
        }
    ...
    enter: function() {
        return new _t(this._enter || this._groups.map(P), this._parents)
    },
    exit: function() {
        return new _t(this._exit || this._groups.map(P), this._parents)
    },
    join: function(t, e, n) {
        var r = this.enter(),
            o = this,
    ...
    merge: function(t) {
        for (var e = t.selection ? t.selection() : t, n = this._groups, r = e._groups, o = n.length, i = r.length, a = Math.min(o, i), u = new Array(o), s = 0; s < a; ++s)
            for (var l, p = n[s], c = r[s], y = p.length, f = u[s] = new Array(y), h = 0; h < y; ++h)(l = p[h] || c[h]) && (f[h] = l);
        for (; s < o; ++s) u[s] = n[s];
    ...
    order: function() {
        for (var t = this._groups, e = -1, n = t.length; ++e < n;)
            for (var r, o = t[e], i = o.length - 1, a = o[i]; --i >= 0;)(r = o[i]) && (a && 4 ^ r.compareDocumentPosition(a) && a.parentNode.insertBefore(r, a), a = r);
        return this
    },
    sort: function(t) {
        function e(e, n) {
        ...
        for (var n = this._groups, r = n.length, o = new Array(r), i = 0; i < r; ++i) {
            for (var a, u = n[i], s = u.length, l = o[i] = new Array(s), p = 0; p < s; ++p)(a = u[p]) && (l[p] = a);
            l.sort(e)
        }
    ...
    each: function(t) {
        for (var e = this._groups, n = 0, r = e.length; n < r; ++n)
            for (var o, i = e[n], a = 0, u = i.length; a < u; ++a)(o = i[a]) && t.call(o, o.__data__, a, i);
        return this
    },
    attr: function(t, e) {
        var n = c(t);
        ...
        return this.each((null == e ? n.local ? k : A : "function" == typeof e ? n.local ? L : T : n.local ? C : R)(n, e))
    },
    style: function(t, e, n) {
        return arguments.length > 1 ? this.each((null == e ? I : "function" == typeof e ? O : $)(t, e, null == n ? "" : n)) : G(this.node(), t)
    },
    property: function(t, e) {
        return arguments.length > 1 ? this.each((null == e ? U : "function" == typeof e ? D : H)(t, e)) : this.node()[t]
    },
    classed: function(t, e) {
        ...
        return this.each(("function" == typeof e ? Z : e ? X : V)(n, e))
    },
    text: function(t) {
        return arguments.length ? this.each(null == t ? W : ("function" == typeof t ? Q : J)(t)) : this.node().textContent
    },
    html: function(t) {
        return arguments.length ? this.each(null == t ? tt : ("function" == typeof t ? nt : et)(t)) : this.node().innerHTML
    },
    raise: function() {
        return this.each(rt)
    },
    ...
    insert: function(t, e) {
        var n = "function" == typeof t ? t : ut(t),
            r = null == e ? st : "function" == typeof e ? e : f(e);
        return this.select((function() {
    ...
    on: function(t, e, n) {
        var r, o, i = yt(t + ""),
            a = i.length;
        if (!(arguments.length < 2)) {
            for (u = e ? ht : ft, r = 0; r < a; ++r) this.each(u(i[r], e, n));
            return this
        }
        var u = this.node().__on;
        if (u)
            for (var s, l = 0, p = u.length; l < p; ++l)
                for (r = 0, s = u[l]; r < a; ++r)
    ...
    [Symbol.iterator]: function*() {
        for (var t = this._groups, e = 0, n = t.length; e < n; ++e)
            for (var r, o = t[e], i = 0, a = o.length; i < a; ++i)(r = o[i]) && (yield r)
    }
};
var Pt = wt;
...
var Et = "\\s*([+-]?(?:\\d*\\.)?\\d+(?:[eE][+-]?\\d+)?)\\s*",
    xt = "\\s*([+-]?(?:\\d*\\.)?\\d+(?:[eE][+-]?\\d+)?)%\\s*",
    Nt = /^#([0-9a-f]{3,8})$/,
    At = new RegExp("^rgb\\(\\s*([+-]?\\d+)\\s*,\\s*([+-]?\\d+)\\s*,\\s*([+-]?\\d+)\\s*\\)$"),
    kt = new RegExp(`^rgb\\(${xt},${xt},${xt}\\)$`),
    Rt = new RegExp(`^rgba\\(\\s*([+-]?\\d+)\\s*,\\s*([+-]?\\d+)\\s*,\\s*([+-]?\\d+)\\s*,${Et}\\)$`),
    Ct = new RegExp(`^rgba\\(${xt},${xt},${xt},${Et}\\)$`),
    Tt = new RegExp(`^hsl\\(${Et},${xt},${xt}\\)$`),
    Lt = new RegExp(`^hsla\\(${Et},${xt},${xt},${Et}\\)$`),
    Bt = {
        aliceblue: 15792383,
...
function Ot(t) {
    var e, n;
    return t = (t + "").trim().toLowerCase(), (e = Nt.exec(t)) ? (n = e[1].length, e = parseInt(e[1], 16), 6 === n ? Gt(e) : 3 === n ? new qt(e >> 8 & 15 | e >> 4 & 240, e >> 4 & 15 | 240 & e, (15 & e) << 4 | 15 & e, 1) : 8 === n ? Ut(e >> 24 & 255, e >> 16 & 255, e >> 8 & 255, (255 & e) / 255) : 4 === n ? Ut(e >> 12 & 15 | e >> 8 & 240, e >> 8 & 15 | e >> 4 & 240, e >> 4 & 15 | 240 & e, ((15 & e) << 4 | 15 & e) / 255) : null) : (e = At.exec(t)) ? new qt(e[1], e[2], e[3], 1) : (e = kt.exec(t)) ? new qt(255 * e[1] / 100, 255 * e[2] / 100, 255 * e[3] / 100, 1) : (e = Rt.exec(t)) ? Ut(e[1], e[2], e[3], e[4]) : (e = Ct.exec(t)) ? Ut(255 * e[1] / 100, 255 * e[2] / 100, 255 * e[3] / 100, e[4]) : (e = Tt.exec(t)) ? Vt(e[1], e[2] / 100, e[3] / 100, 1) : (e = Lt.exec(t)) ? Vt(e[1], e[2] / 100, e[3] / 100, e[4]) : Bt.hasOwnProperty(t) ? Gt(Bt[t]) : "transparent" === t ? new qt(NaN, NaN, NaN, 0) : null
}
...
function Ht(t) {
    return t instanceof St || (t = Ot(t)), t ? new qt((t = t.rgb()).r, t.g, t.b, t.opacity) : new qt
}

function Dt(t, e, n, r) {
    return 1 === arguments.length ? Ht(t) : new qt(t, e, n, null == r ? 1 : r)
}
...
function zt() {
    ...
    return `${1===t?"rgb(":"rgba("}${Yt(this.r)}, ${Yt(this.g)}, ${Yt(this.b)}${1===t?")":`, ${t})`}`
}
...
function Xt(t) {
    return ((t = Yt(t)) < 16 ? "0" : "") + t.toString(16)
}
...
function Zt(t) {
    ...
    if (t instanceof St || (t = Ot(t)), !t) return new Wt;
    ...
    var e = (t = t.rgb()).r / 255,
        ...
        u = i - o,
        s = (i + o) / 2;
    return u ? (a = e === i ? (n - r) / u + 6 * (n < r) : n === i ? (r - e) / u + 2 : (e - n) / u + 4, u /= s < .5 ? i + o : 2 - i - o, a *= 60) : u = s > 0 && s < 1 ? 0 : a, new Wt(a, u, s, t.opacity)
}
...
bt(St, Ot, {
    ...
    brighter(t) {
        return t = null == t ? 1.4285714285714286 : Math.pow(1.4285714285714286, t), new qt(this.r * t, this.g * t, this.b * t, this.opacity)
    },
    darker(t) {
    ...
    clamp() {
        return new qt(Yt(this.r), Yt(this.g), Yt(this.b), Kt(this.opacity))
    },
    displayable() {
    ...
    formatHex: jt,
    formatHex8: function() {
        return `#${Xt(this.r)}${Xt(this.g)}${Xt(this.b)}${Xt(255*(isNaN(this.opacity)?1:this.opacity))}`
    },
    formatRgb: zt,
    toString: zt
})), bt(Wt, (function(t, e, n, r) {
    return 1 === arguments.length ? Zt(t) : new Wt(t, e, n, null == r ? 1 : r)
}), Mt(St, {
    brighter(t) {
        return t = null == t ? 1.4285714285714286 : Math.pow(1.4285714285714286, t), new Wt(this.h, this.s, this.l * t, this.opacity)
    },
    darker(t) {
    ...
    rgb() {
        var t = this.h % 360 + 360 * (this.h < 0),
            ...
            r = n + (n < .5 ? n : 1 - n) * e,
            o = 2 * n - r;
        return new qt(te(t >= 240 ? t - 240 : t + 120, o, r), te(t, o, r), te(t < 120 ? t + 240 : t - 120, o, r), this.opacity)
    },
    clamp() {
        return new Wt(Jt(this.h), Qt(this.s), Qt(this.l), Kt(this.opacity))
    },
    displayable() {
    ...
    formatHsl() {
        const t = Kt(this.opacity);
        return `${1===t?"hsl(":"hsla("}${Jt(this.h)}, ${100*Qt(this.s)}%, ${100*Qt(this.l)}%${1===t?")":`, ${t})`}`
    }
}));
var ne = t => () => t;
...
function ie(t, e) {
    var n = e - t;
    return n ? re(t, n) : ne(isNaN(t) ? e : t)
}
var ae = function t(e) {
    var n = oe(e);
...
function ue(t) {
    return function(e) {
        var n, r, o = e.length,
            ...
            a = new Array(o),
            u = new Array(o);
        for (n = 0; n < o; ++n) r = Dt(e[n]), i[n] = r.r || 0, a[n] = r.g || 0, u[n] = r.b || 0;
...
var le = /[-+]?(?:\d+\.?\d*|\.?\d+)(?:[eE][-+]?\d+)?/g,
    pe = new RegExp(le.source, "g");

function ce(t, e) {
    var n, r, o, i = le.lastIndex = pe.lastIndex = 0,
        a = -1,
        u = [],
        s = [];
    for (t += "", e += "";
        (n = le.exec(t)) && (r = pe.exec(e));)(o = r.index) > i && (o = e.slice(i, o), u[a] ? u[a] += o : u[++a] = o), (n = n[0]) === (r = r[0]) ? u[a] ? u[a] += r : u[++a] = r : (u[++a] = null, s.push({
        i: a,
        x: se(n, r)
    })), i = pe.lastIndex;
    return i < e.length && (o = e.slice(i), u[a] ? u[a] += o : u[++a] = o), u.length < 2 ? s[0] ? function(t) {
        return function(e) {
            return t(e) + ""
        }
    }(s[0].x) : function(t) {
...
function ge(t, e, n, r) {
    ...
    return function(i, a) {
        ...
        return i = t(i), a = t(a),
            ...
            }(i.scaleX, i.scaleY, a.scaleX, a.scaleY, u, s), i = a = null,
            function(t) {
...
var me = ge((function(t) {
        const e = new("function" == typeof DOMMatrix ? DOMMatrix : WebKitCSSMatrix)(t + "");
        return e.isIdentity ? he : de(e.a, e.b, e.c, e.d, e.e, e.f)
    }), "px, ", "px)", "deg)"),
    ve = ge((function(t) {
        return null == t ? he : (ye || (ye = document.createElementNS("http://www.w3.org/2000/svg", "g")), ye.setAttribute("transform", t), (t = ye.transform.baseVal.consolidate()) ? de((t = t.matrix).a, t.b, t.c, t.d, t.e, t.f) : he)
    }), ", ", ")", ")");
...
function _e(t) {
    ...
    function o(t, o) {
        var i, a, u = t[0],
            ...
            h = c - s,
            d = f * f + h * h;
        if (d < 1e-12) a = Math.log(y / l) / e, i = function(t) {
            return [u + t * f, s + t * h, l * Math.exp(e * t * a)]
        };
        else {
            var g = Math.sqrt(d),
                m = (y * y - l * l + r * d) / (2 * l * n * g),
                v = (y * y - l * l - r * d) / (2 * y * n * g),
                _ = Math.log(Math.sqrt(m * m + 1) - m),
                w = Math.log(Math.sqrt(v * v + 1) - v);
            a = (w - _) / e, i = function(t) {
                var r, o = t * a,
                    i = _e(_),
                    p = l / (n * g) * (i * (r = e * o + _, ((r = Math.exp(2 * r)) - 1) / (r + 1)) - function(t) {
                        return ((t = Math.exp(t)) - 1 / t) / 2
                    }(_));
                return [u + p * f, s + p * h, l * i / _e(e * o + _)]
            }
        }
...
function Le() {
    Ee = (Se = Ne.now()) + xe, Fe = be = 0;
    try {
        ! function() {
            ke(), ++Fe;
            for (var t, e = we; e;)(t = Ee - e._time) >= 0 && e._call.call(void 0, t), e = e._next;
            --Fe
        }()
    } finally {
        Fe = 0,
            function() {
                var t, e, n = we,
                    r = 1 / 0;
                for (; n;) n._call ? (r > n._time && (r = n._time), t = n, n = n._next) : (e = n._next, n._next = null, n = t ? t._next = e : we = e);
                Pe = t, Ie(r)
            }(), Ee = 0
    }
}
...
function Ie(t) {
    Fe || (be && (be = clearTimeout(be)), t - Ee > 24 ? (t < 1 / 0 && (be = setTimeout(Le, t - Ne.now() - xe)), Me && (Me = clearInterval(Me))) : (Me || (Se = Ne.now(), Me = setInterval(Be, 1e3)), Fe = 1, Ae(Le)))
}
...
Ce.prototype = Te.prototype = {
    ...
    restart: function(t, e, n) {
        ...
        n = (null == n ? ke() : +n) + (null == e ? 0 : +e), this._next || Pe === this || (Pe ? Pe._next = this : we = this, Pe = this), this._call = t, this._time = n, Ie()
    },
    stop: function() {
        this._call && (this._call = null, this._time = 1 / 0, Ie())
    }
};
var Oe = u("start", "end", "cancel", "interrupt"),
    Ge = [];
...
function Ue(t, e, n, r, o, i) {
    ...
    ! function(t, e, n) {
        ...
        function a(i) {
            ...
            for (l in o)
                if ((y = o[l]).name === n.name) {
                    if (3 === y.state) return $e(a);
                    4 === y.state ? (y.state = 6, y.timer.stop(), y.on.call("interrupt", t, t.__data__, y.index, y.group), delete o[l]) : +l < e && (y.state = 6, y.timer.stop(), y.on.call("cancel", t, t.__data__, y.index, y.group), delete o[l])
                } if ($e((function() {
                    3 === n.state && (n.state = 4, n.timer.restart(u, n.delay, n.time), u(i))
                })), n.state = 2, n.on.call("start", t, t.__data__, n.index, n.group), 2 === n.state) {
                for (n.state = 3, r = new Array(c = n.tween.length), l = 0, p = -1; l < c; ++l)(y = n.tween[l].value.call(t, t.__data__, n.index, n.group)) && (r[++p] = y);
                r.length = p + 1
            }
        }
...
function Ye(t, e, n) {
    ...
    return t.each((function() {
        ...
        function(t) {
            return qe(t, r).value[e]
        }
}

function Xe(t, e) {
    var n;
    return ("number" == typeof e ? se : e instanceof Ot ? ae : (n = Ot(e)) ? (e = n, ae) : ce)(t, e)
}
...
function Qe(t, e, n) {
    ...
    return function() {
        var a, u, s = n(this);
        if (null != s) return (a = this.getAttribute(t)) === (u = s + "") ? null : a === r && u === o ? i : (o = u, i = e(r = a, s));
        this.removeAttribute(t)
    }
}
...
function tn(t, e, n) {
    ...
    return function() {
        var a, u, s = n(this);
        if (null != s) return (a = this.getAttributeNS(t.space, t.local)) === (u = s + "") ? null : a === r && u === o ? i : (o = u, i = e(r = a, s));
        this.removeAttributeNS(t.space, t.local)
    }
}
...
function sn(t, e) {
    return function() {
        De(this, t).duration = +e.apply(this, arguments)
    }
}
...
var yn = Pt.prototype.constructor;
...
_n.prototype = function(t) {
    ...
    select: function(t) {
        ...
        for (var r = this._groups, o = r.length, i = new Array(o), a = 0; a < o; ++a)
            for (var u, s, l = r[a], p = l.length, c = i[a] = new Array(p), y = 0; y < p; ++y)(u = l[y]) && (s = t.call(u, u.__data__, y, l)) && ("__data__" in u && (s.__data__ = u.__data__), c[y] = s, Ue(c[y], e, n, y, c, qe(u, n)));
    ...
    selectAll: function(t) {
        ...
        for (var r = this._groups, o = r.length, i = [], a = [], u = 0; u < o; ++u)
            for (var s, l = r[u], p = l.length, c = 0; c < p; ++c)
                if (s = l[c]) {
                    for (var y, f = t.call(s, s.__data__, c, l), h = qe(s, n), d = 0, m = f.length; d < m; ++d)(y = f[d]) && Ue(y, e, n, d, f, h);
                    i.push(f), a.push(s)
                } return new _n(i, a, e, n)
    },
    ...
    merge: function(t) {
        ...
        for (var e = this._groups, n = t._groups, r = e.length, o = n.length, i = Math.min(r, o), a = new Array(r), u = 0; u < i; ++u)
            for (var s, l = e[u], p = n[u], c = l.length, y = a[u] = new Array(c), f = 0; f < c; ++f)(s = l[f] || p[f]) && (y[f] = s);
        for (; u < r; ++u) a[u] = e[u];
        return new _n(a, this._parents, this._name, this._id)
    },
    selection: function() {
        return new yn(this._groups, this._parents)
    },
    transition: function() {
        for (var t = this._name, e = this._id, n = wn(), r = this._groups, o = r.length, i = 0; i < o; ++i)
    ...
    on: function(t, e) {
        var n = this._id;
        return arguments.length < 2 ? qe(this.node(), n).on.on(t) : this.each(cn(n, t, e))
    },
    attr: function(t, e) {
        var n = c(t),
            r = "transform" === n ? ve : Xe;
        return this.attrTween(t, "function" == typeof e ? (n.local ? tn : Qe)(n, r, Ye(this, "attr." + t, e)) : null == e ? (n.local ? Ze : Ve)(n) : (n.local ? Je : We)(n, r, e))
    },
    attrTween: function(t, e) {
        ...
        if ("function" != typeof e) throw new Error;
        var r = c(t);
        return this.tween(n, (r.local ? rn : on)(r, e))
    },
    style: function(t, e, n) {
        var r = "transform" == (t += "") ? me : Xe;
        ...
        }(t, r)).on("end.style." + t, fn(t)) : "function" == typeof e ? this.styleTween(t, function(t, e, n) {
            var r, o, i;
            return function() {
                var a = G(this, t),
                    u = n(this),
                    s = u + "";
                return null == u && (this.style.removeProperty(t), s = u = G(this, t)), a === s ? null : a === r && s === o ? i : (o = s, i = e(r = a, u))
            }
        }(t, r, Ye(this, "style." + t, e))).each(function(t, e) {
            var n, r, o, i, a = "style." + e,
                u = "end." + a;
            return function() {
                var s = De(this, t),
                    l = s.on,
                    p = null == s.value[a] ? i || (i = fn(e)) : void 0;
                l === n && o === p || (r = (n = l).copy()).on(u, o = p), s.on = r
            }
    ...
    tween: function(t, e) {
        ...
        if (t += "", arguments.length < 2) {
            for (var r, o = qe(this.node(), n).tween, i = 0, a = o.length; i < a; ++i)
                if ((r = o[i]).name === t) return r.value;
            return null
        }
        return this.each((null == e ? ze : Ke)(n, t, e))
    },
    delay: function(t) {
        var e = this._id;
        return arguments.length ? this.each(("function" == typeof t ? an : un)(e, t)) : qe(this.node(), e).delay
    },
    duration: function(t) {
        var e = this._id;
        return arguments.length ? this.each(("function" == typeof t ? sn : ln)(e, t)) : qe(this.node(), e).duration
    },
    ease: function(t) {
        var e = this._id;
        return arguments.length ? this.each(pn(e, t)) : qe(this.node(), e).ease
    },
    easeVarying: function(t) {
        ...
        return new Promise((function(i, a) {
            ...
            n.each((function() {
                var n = De(this, r),
                    o = n.on;
                o !== t && ((e = (t = o).copy())._.cancel.push(u), e._.interrupt.push(u), e._.end.push(s)), n.on = e
            })), 0 === o && i()
        }))
    },
...
Pt.prototype.interrupt = function(t) {
    ...
    var e, n;
    t instanceof _n ? (e = t._id, t = t._name) : (e = wn(), (n = Fn).time = ke(), t = null == t ? null : t + "");
    for (var r = this._groups, o = r.length, i = 0; i < o; ++i)
        for (var a, u = r[i], s = u.length, l = 0; l < s; ++l)(a = u[l]) && Ue(a, t, e, l, u, n || bn(a, e));
...
function Nn(t) {
    return [xn(t[0]), xn(t[1])]
} ["w", "e"].map(An), ["n", "s"].map(An), ["n", "w", "e", "s", "nw", "ne", "sw", "se"].map(An);
...
function Rn(t, e) {
    t && Tn.hasOwnProperty(t.type) && Tn[t.type](t, e)
}
var Cn = {
        ...
        FeatureCollection: function(t, e) {
            for (var n = t.features, r = -1, o = n.length; ++r < o;) Rn(n[r].geometry, e)
        }
    },
    Tn = {
        Sphere: function(t, e) {
        ...
        MultiLineString: function(t, e) {
            for (var n = t.coordinates, r = -1, o = n.length; ++r < o;) Ln(n[r], e, 0)
        },
        Polygon: function(t, e) {
            Bn(t.coordinates, e)
        },
        MultiPolygon: function(t, e) {
            for (var n = t.coordinates, r = -1, o = n.length; ++r < o;) Bn(n[r], e)
        },
        GeometryCollection: function(t, e) {
            for (var n = t.geometries, r = -1, o = n.length; ++r < o;) Rn(n[r], e)
        }
    };
...
function In(t, e) {
    t && Cn.hasOwnProperty(t.type) ? Cn[t.type](t, e) : Rn(t, e)
}
class $n {
    constructor() {
    ...
    valueOf() {
        ...
        let e, n, r, o = this._n,
            i = 0;
        if (o > 0) {
            for (i = t[--o]; o > 0 && (e = i, n = t[--o], i = e + n, r = n - (i - e), !r););
            o > 0 && (r < 0 && t[o - 1] < 0 || r > 0 && t[o - 1] > 0) && (n = 2 * r, e = i + n, n == e - i && (i = e))
        }
        return i
    }
}
...
var Gn = Math.PI,
    ...
    Yn = Math.atan2,
    Xn = Math.cos,
    Vn = (Math.ceil, Math.exp),
    Zn = (Math.floor, Math.hypot, Math.log),
    Wn = (Math.pow, Math.sin),
    Jn = Math.sign || function(t) {
...
var rr, or, ir, ar, ur = new $n,
    ...
    lr = {
        ...
        polygonStart: function() {
            lr.lineStart = pr, lr.lineEnd = fr
        },
        polygonEnd: function() {
            lr.lineStart = lr.lineEnd = lr.point = nr, ur.add(zn(sr)), sr = new $n
        },
        result: function() {
            var t = ur / 2;
            return ur = new $n, t
...
function cr(t, e) {
    lr.point = yr, rr = ir = t, or = ar = e
}

function yr(t, e) {
    sr.add(ar * t - ir * e), ir = t, ar = e
}
...
var _r, wr, Pr, Fr, br = {
    ...
    Tr = {
        ...
        lineEnd: Or,
        polygonStart: function() {
            Tr.lineStart = Gr, Tr.lineEnd = Ur
        },
        polygonEnd: function() {
            Tr.point = Lr, Tr.lineStart = Br, Tr.lineEnd = Or
        },
        result: function() {
            var t = Cr ? [kr / Cr, Rr / Cr] : Ar ? [xr / Ar, Nr / Ar] : Er ? [Mr / Er, Sr / Er] : [NaN, NaN];
            return Mr = Sr = Er = xr = Nr = Ar = kr = Rr = Cr = 0, t
        }
    };
...
function $r(t, e) {
    var n = t - Pr,
        r = e - Fr,
        o = Qn(n * n + r * r);
    xr += o * (Pr + t) / 2, Nr += o * (Fr + e) / 2, Ar += o, Lr(Pr = t, Fr = e)
}
...
function Hr(t, e) {
    Tr.point = Dr, Lr(_r = Pr = t, wr = Fr = e)
}
...
function Dr(t, e) {
    var n = t - Pr,
        r = e - Fr,
        o = Qn(n * n + r * r);
    xr += o * (Pr + t) / 2, Nr += o * (Fr + e) / 2, Ar += o, kr += (o = Fr * t - Pr * e) * (Pr + t), Rr += o * (Fr + e), Cr += 3 * o, Lr(Pr = t, Fr = e)
}
var qr = Tr;
    ...
    point: function(t, e) {
        switch (this._point) {
            ...
            case 1:
                ...
                break;
            default:
                this._context.moveTo(t + this._radius, e), this._context.arc(t, e, this._radius, 0, Dn)
        }
    },
    result: nr
};
var zr, Kr, Yr, Xr, Vr, Zr = new $n,
    Wr = {
        point: nr,
        lineStart: function() {
            Wr.point = Jr
...
function Jr(t, e) {
    Wr.point = Qr, Kr = Xr = t, Yr = Vr = e
}

function Qr(t, e) {
    Xr -= t, Vr -= e, Zr.add(Qn(Xr * Xr + Vr * Vr)), Xr = t, Vr = e
}
var to = Wr;
...
function oo(t, e) {
    return [zn(t) > Gn ? t + Math.round(-t / Dn) * Dn : t, e]
}

function io(t, e, n) {
    return (t %= Dn) ? e || n ? ro(uo(t), so(e, n)) : uo(t) : e || n ? so(e, n) : oo
}

function ao(t) {
    return function(e, n) {
        return [(e += t) > Gn ? e - Dn : e < -Gn ? e + Dn : e, n]
    }
}
...
function so(t, e) {
    ...
    function a(t, e) {
        var a = Xn(e),
            ...
            l = Wn(e),
            p = l * n + u * r;
        return [Yn(s * o - p * i, u * n - l * r), er(p * o + s * i)]
    }
    return a.invert = function(t, e) {
        var a = Xn(e),
            ...
            l = Wn(e),
            p = l * o - s * i;
        return [Yn(s * o + l * i, u * n + p * r), er(p * n - u * r)]
    }, a
}

function lo(t) {
    function e(e) {
        return (e = t(e[0] * jn, e[1] * jn))[0] *= qn, e[1] *= qn, e
    }
    return t = io(t[0] * jn, t[1] * jn, t.length > 2 ? t[2] * jn : 0), e.invert = function(e) {
        return (e = t.invert(e[0] * jn, e[1] * jn))[0] *= qn, e[1] *= qn, e
    }, e
}
...
function co(t, e) {
    return zn(t[0] - e[0]) < 1e-6 && zn(t[1] - e[1]) < 1e-6
}
...
function fo(t, e, n, r, o) {
    ...
    if (t.forEach((function(t) {
            if (!((e = t.length - 1) <= 0)) {
                ...
                u.push(n = new yo(r, t, null, !0)), s.push(n.o = new yo(r, null, n, !1)), u.push(n = new yo(a, t, null, !1)), s.push(n.o = new yo(a, null, n, !0))
            }
        })), u.length) {
        for (s.sort(e), ho(u), ho(s), i = 0, a = s.length; i < a; ++i) s[i].e = n = !n;
        for (var l, p, c = u[0];;) {
            for (var y = c, f = !0; y.v;)
                if ((y = y.n) === c) return;
            l = y.z, o.lineStart();
            do {
                if (y.v = y.o.v = !0, y.e) {
                    if (f)
                        for (i = 0, a = l.length; i < a; ++i) o.point((p = l[i])[0], p[1]);
                    else r(y.x, y.n.x, 1, o);
                    y = y.n
                } else {
                    if (f)
                        for (l = y.p.z, i = l.length - 1; i >= 0; --i) o.point((p = l[i])[0], p[1]);
                    else r(y.x, y.p.x, -1, o);
                    y = y.p
                }
                l = (y = y.o).z, f = !f
            } while (!y.v);
...
function bo(t) {
    return zn(t[0]) <= Gn ? t[0] : Jn(t[0]) * ((zn(t[0]) + Gn) % Dn - Gn)
}
...
function Mo(t, e) {
    var n = bo(e),
        ...
        u = 0,
        s = new $n;
    1 === o ? r = Un + 1e-6 : -1 === o && (r = -Un - 1e-6);
    for (var l = 0, p = t.length; l < p; ++l)
        if (y = (c = t[l]).length)
            for (var c, y, f = c[y - 1], h = bo(f), d = f[1] / 2 + Hn, g = Wn(d), m = Xn(d), v = 0; v < y; ++v, h = w, g = F, m = b, f = _) {
                var _ = c[v],
                    w = bo(_),
                    P = _[1] / 2 + Hn,
                    F = Wn(P),
                    ...
                    x = E > Gn,
                    N = g * F;
                if (s.add(Yn(N * S * Wn(E), m * b + N * Xn(E))), a += x ? M + S * Dn : M, x ^ h >= n ^ w >= n) {
                    var A = _o(mo(f), mo(_));
                    Fo(A);
                    var k = _o(i, A);
                    Fo(k);
                    var R = (x ^ M >= 0 ? -1 : 1) * er(k[2]);
                    (r > R || r === R && (A[0] || A[1])) && (u += x ^ M >= 0 ? 1 : -1)
                }
            }
    return (a < -1e-6 || a < 1e-6 && s < -1e-12) ^ 1 & u
}
    ...
    return function(o) {
        var i, a, u, s = e(o),
            ...
            y = {
                ...
                lineEnd: g,
                polygonStart: function() {
                    y.point = m, y.lineStart = v, y.lineEnd = _, a = [], i = []
                },
                polygonEnd: function() {
                    y.point = f, y.lineStart = d, y.lineEnd = g, a = On(a);
                    var t = Mo(i, r);
                    a.length ? (c || (o.polygonStart(), c = !0), fo(a, xo, t, n, o)) : t && (c || (o.polygonStart(), c = !0), o.lineStart(), n(null, null, 1, o), o.lineEnd()), c && (o.polygonEnd(), c = !1), a = i = null
                },
                sphere: function() {
        ...
        function _() {
            ...
            var t, e, n, r, s = p.clean(),
                y = l.result(),
                f = y.length;
            if (u.pop(), i.push(u), u = null, f)
                if (1 & s) {
                    if ((e = (n = y[0]).length - 1) > 0) {
                        for (c || (o.polygonStart(), c = !0), o.lineStart(), t = 0; t < e; ++t) o.point((r = n[t])[0], r[1]);
                        o.lineEnd()
                    }
                } else f > 1 && 2 & s && y.push(y.pop().concat(y.shift())), a.push(y.filter(Eo))
        }
        return y
    }
}
...
function xo(t, e) {
    return ((t = t.x)[0] < 0 ? t[1] - Un - 1e-6 : Un - t[1]) - ((e = e.x)[0] < 0 ? e[1] - Un - 1e-6 : Un - e[1])
}
eo.prototype = {
    _radius: 4.5,
    _circle: no(4.5),
...
var No = So((function() {
    ...
    return {
        ...
        point: function(i, a) {
            var u = i > 0 ? Gn : -Gn,
                s = zn(i - n);
            zn(s - Gn) < 1e-6 ? (t.point(n, r = (r + a) / 2 > 0 ? Un : -Un), t.point(o, r), t.lineEnd(), t.lineStart(), t.point(u, r), t.point(i, r), e = 0) : o !== u && s >= Gn && (zn(n - o) < 1e-6 && (n -= 1e-6 * o), zn(i - u) < 1e-6 && (i -= 1e-6 * u), r = function(t, e, n, r) {
                var o, i, a = Wn(t - n);
                return zn(a) > 1e-6 ? Kn((Wn(e) * (i = Xn(r)) * Wn(n) - Wn(r) * (o = Xn(e)) * Wn(t)) / (o * i * a)) : (e + r) / 2
            }(n, r, i, a), t.point(o, r), t.lineEnd(), t.lineStart(), t.point(u, r), e = 0), t.point(n = i, r = a), o = u
        },
        lineEnd: function() {
            t.lineEnd(), n = r = NaN
        },
    ...
    var o;
    if (null == t) o = n * Un, r.point(-Gn, o), r.point(0, o), r.point(Gn, o), r.point(Gn, 0), r.point(Gn, -o), r.point(0, -o), r.point(-Gn, -o), r.point(-Gn, 0), r.point(-Gn, o);
    else if (zn(t[0] - e[0]) > 1e-6) {
        var i = t[0] < e[0] ? Gn : -Gn;
...
function Ao(t, e, n, r, o, i) {
    if (n) {
        var a = Xn(e),
            u = Wn(e),
            s = r * n;
        null == o ? (o = e + r * Dn, i = e - s / 2) : (o = ko(a, o), i = ko(a, i), (r > 0 ? o < i : o > i) && (o += r * Dn));
        for (var l, p = o; r > 0 ? p > i : p < i; p -= s) l = go([a, -u * Xn(p), -u * Wn(p)]), t.point(l[0], l[1])
    }
}

function ko(t, e) {
    (e = mo(e))[0] -= t, Fo(e);
    var n, r = (n = -e[1]) > 1 ? 0 : n < -1 ? Gn : Math.acos(n);
    return ((-e[2] < 0 ? -r : r) + Dn - 1e-6) % Dn
}
...
function Ro(t) {
    ...
    function a(t, n, r) {
        ...
        if (!(g < 0)) {
            ...
            var M = P - w,
                S = zn(M - Gn) < 1e-6;
            if (!S && b < F && (_ = F, F = b, b = _), S || M < 1e-6 ? S ? F + b > 0 ^ v[1] < (zn(v[0] - w) < 1e-6 ? F : b) : F <= v[1] && v[1] <= b : M > Gn ^ (w <= v[0] && v[0] <= P)) {
                var E = Po(f, (-h + m) / d);
                return wo(E, y), [v, go(E)]
            }
        }
    }
    ...
    return So(i, (function(t) {
        ...
        return {
            ...
            point: function(c, y) {
                var f, h = [c, y],
                    d = i(c, y),
                    g = r ? d ? 0 : u(c, y) : d ? u(c + (c < 0 ? Gn : -Gn), y) : 0;
                if (!e && (l = s = d) && t.lineStart(), d !== s && (!(f = a(e, h)) || co(e, f) || co(h, f)) && (h[2] = 1), d !== s) p = 0, d ? (t.lineStart(), f = a(h, e), t.point(f[0], f[1])) : (f = a(e, h), t.point(f[0], f[1], 2), t.lineEnd()), e = f;
                else if (o && e && r ^ d) {
                    var m;
                    g & n || !(m = a(h, e, !0)) || (p = 0, r ? (t.lineStart(), t.point(m[0][0], m[0][1]), t.point(m[1][0], m[1][1]), t.lineEnd()) : (t.point(m[1][0], m[1][1]), t.lineEnd(), t.lineStart(), t.point(m[0][0], m[0][1], 3)))
                }!d || e && co(e, h) || t.point(h[0], h[1]), e = h, s = d, n = g
            },
            lineEnd: function() {
                s && t.lineEnd(), e = null
            },
        ...
        if (a = o - u, c || !(a < 0)) {
            ...
            if (a = r - s, y || !(a > 0)) {
                ...
                if (a = i - s, y || !(a < 0)) {
                    ...
                    return l > 0 && (t[0] = u + l * c, t[1] = s + l * y), p < 1 && (e[0] = u + p * c, e[1] = s + p * y), !0
                }
            }
        }
    }
...
function To(t, e, n, r) {
    ...
    function i(o, i, u, l) {
        var p = 0,
            c = 0;
        if (null == o || (p = a(o, u)) !== (c = a(i, u)) || s(o, i) < 0 ^ u > 0)
            do {
                l.point(0 === p || 3 === p ? t : n, p > 1 ? r : e)
            } while ((p = (p + u + 4) % 4) !== c);
        else l.point(i[0], i[1])
    }

    function a(r, o) {
        return zn(r[0] - t) < 1e-6 ? o > 0 ? 0 : 3 : zn(r[0] - n) < 1e-6 ? o > 0 ? 2 : 1 : zn(r[1] - e) < 1e-6 ? o > 0 ? 1 : 0 : o > 0 ? 3 : 2
    }
    ...
    return function(a) {
        var s, l, p, c, y, f, h, d, g, m, v, _ = a,
            w = po(),
            P = {
                point: F,
                lineStart: function() {
                    P.point = b, l && l.push(p = []);
                    m = !0, g = !1, h = d = NaN
                },
                lineEnd: function() {
                    s && (b(c, y), f && g && w.rejoin(), s.push(w.result()));
                    P.point = F, g && _.lineEnd()
                },
                polygonStart: function() {
                    _ = w, s = [], l = [], v = !0
                },
                polygonEnd: function() {
                    var e = function() {
                            for (var e = 0, n = 0, o = l.length; n < o; ++n)
                                for (var i, a, u = l[n], s = 1, p = u.length, c = u[0], y = c[0], f = c[1]; s < p; ++s) i = y, a = f, y = (c = u[s])[0], f = c[1], a <= r ? f > r && (y - i) * (r - a) > (f - a) * (t - i) && ++e : f <= r && (y - i) * (r - a) < (f - a) * (t - i) && --e;
                            return e
                        }(),
                        n = v && e,
                        o = (s = On(s)).length;
                    (n || o) && (a.polygonStart(), n && (a.lineStart(), i(null, null, 1, a), a.lineEnd()), o && fo(s, u, e, i, a), a.polygonEnd());
                    _ = a, s = l = p = null
                }
            };
        ...
        function b(i, a) {
            var u = o(i, a);
            if (l && p.push([i, a]), m) c = i, y = a, f = u, m = !1, u && (_.lineStart(), _.point(i, a));
            else if (u && g) _.point(i, a);
            else {
                var s = [h = Math.max(-1e9, Math.min(1e9, h)), d = Math.max(-1e9, Math.min(1e9, d))],
                    w = [i = Math.max(-1e9, Math.min(1e9, i)), a = Math.max(-1e9, Math.min(1e9, a))];
                Co(s, w, t, e, n, r) ? (g || (_.lineStart(), _.point(s[0], s[1])), _.point(w[0], w[1]), u || _.lineEnd(), v = !1) : u && (_.lineStart(), _.point(i, a), v = !1)
            }
            h = i, d = a, g = u
        }
        return P
...
function Io(t, e, n) {
    ...
    return t.scale(150).translate([0, 0]), null != r && t.clipExtent(null), In(n, t.stream(br)), e(br.result()), null != r && t.clipExtent(r), t
}

function $o(t, e, n) {
    return Io(t, (function(n) {
        var r = e[1][0] - e[0][0],
            o = e[1][1] - e[0][1],
            i = Math.min(r / (n[1][0] - n[0][0]), o / (n[1][1] - n[0][1])),
            a = +e[0][0] + (r - i * (n[1][0] + n[0][0])) / 2,
            u = +e[0][1] + (o - i * (n[1][1] + n[0][1])) / 2;
...
function Do(t, e) {
    return +e ? function(t, e) {
        function n(r, o, i, a, u, s, l, p, c, y, f, h, d, g) {
            var m = l - r,
                v = p - o,
                _ = m * m + v * v;
            if (_ > 4 * e && d--) {
                var w = a + y,
                    ...
                    b = Qn(w * w + P * P + F * F),
                    M = er(F /= b),
                    S = zn(zn(F) - 1) < 1e-6 || zn(i - c) < 1e-6 ? (i + c) / 2 : Yn(P, w),
                    E = t(S, M),
                    x = E[0],
                    N = E[1],
                    A = x - r,
                    k = N - o,
                    R = v * A - m * k;
                (R * R / _ > e || zn((m * A + v * k) / _ - .5) > .3 || a * y + u * f + s * h < Ho) && (n(r, o, i, a, u, s, x, N, S, w /= b, P /= b, F, d, g), g.point(x, N), n(x, N, S, w, P, F, l, p, c, y, f, h, d, g))
            }
        }
        return function(e) {
            var r, o, i, a, u, s, l, p, c, y, f, h, d = {
                point: g,
                lineStart: m,
                lineEnd: _,
                polygonStart: function() {
                    e.polygonStart(), d.lineStart = w
                },
                polygonEnd: function() {
                    e.polygonEnd(), d.lineStart = m
                }
            };
            ...
            function m() {
                p = NaN, d.point = v, e.lineStart()
            }

            function v(r, o) {
                var i = mo([r, o]),
                    a = t(r, o);
                n(p, c, l, y, f, h, p = a[0], c = a[1], l = r, y = i[0], f = i[1], h = i[2], 16, e), e.point(p, c)
            }
            ...
            function w() {
                m(), d.point = P, d.lineEnd = F
            }

            function P(t, e) {
                v(r = t, e), o = p, i = c, a = y, u = f, s = h, d.point = v
            }

            function F() {
                n(p, c, l, y, f, h, o, i, r, a, u, s, 16, e), d.lineEnd = _, _()
            }
            return d
        }
    }(t, e) : function(t) {
...
function jo(t, e, n, r, o, i) {
    if (!i) return function(t, e, n, r, o) {
        function i(i, a) {
            return [e + t * (i *= r), n - t * (a *= o)]
        }
        return i.invert = function(i, a) {
            return [(i - e) / t * r, (n - a) / t * o]
        }, i
    }(t, e, n, r, o);
    var a = Xn(i),
        u = Wn(i),
    ...
    function h(t, i) {
        return [s * (t *= r) - l * (i *= o) + e, n - l * t - s * i]
    }
    return h.invert = function(t, e) {
        return [r * (p * t - c * e + y), o * (f - c * t - p * e)]
    }, h
}

function zo(t) {
    return function(t) {
        var e, n, r, o, i, a, u, s, l, p, c = 150,
            y = 480,
            f = 250,
            h = 0,
            d = 0,
        ...
        function x(t) {
            return s(t[0] * jn, t[1] * jn)
        }

        function N(t) {
            return (t = s.invert(t[0], t[1])) && [t[0] * qn, t[1] * qn]
        }

        function A() {
            var t = jo(c, 0, 0, w, P, _).apply(null, e(h, d)),
                r = jo(c, y - t[0], f - t[1], w, P, _);
            return n = io(g, m, v), u = ro(e, r), s = ro(n, u), a = Do(u, E), k()
        }

        function k() {
            return l = p = null, x
        }
        return x.stream = function(t) {
                return l && p === t ? l : l = qo(function(t) {
                    return Lo({
                        point: function(e, n) {
                            var r = t(e, n);
                ...
                return arguments.length ? (b = t, F = void 0, k()) : b
            }, x.postclip = function(t) {
                return arguments.length ? (S = t, M = r = o = i = null, k()) : S
            }, x.clipAngle = function(t) {
                return arguments.length ? (b = +t ? Ro(F = t * jn) : (F = null, No), k()) : F * qn
            }, x.clipExtent = function(t) {
                return arguments.length ? (S = null == t ? (M = r = o = i = null, kn) : To(M = +t[0][0], r = +t[0][1], o = +t[1][0], i = +t[1][1]), k()) : null == M ? null : [
                    [M, r],
                    [o, i]
                ]
            }, x.scale = function(t) {
                ...
                return arguments.length ? (y = +t[0], f = +t[1], A()) : [y, f]
            }, x.center = function(t) {
                return arguments.length ? (h = t[0] % 360 * jn, d = t[1] % 360 * jn, A()) : [h * qn, d * qn]
            }, x.rotate = function(t) {
                return arguments.length ? (g = t[0] % 360 * jn, m = t[1] % 360 * jn, v = t.length > 2 ? t[2] % 360 * jn : 0, A()) : [g * qn, m * qn, v * qn]
            }, x.angle = function(t) {
                return arguments.length ? (_ = t % 360 * jn, A()) : _ * qn
            }, x.reflectX = function(t) {
                return arguments.length ? (w = t ? -1 : 1, A()) : w < 0
            }, x.reflectY = function(t) {
                return arguments.length ? (P = t ? -1 : 1, A()) : P < 0
            }, x.precision = function(t) {
                return arguments.length ? (a = Do(u, E = t * t), k()) : Qn(E)
            }, x.fitExtent = function(t, e) {
                return $o(x, t, e)
            }, x.fitSize = function(t, e) {
                return Oo(x, t, e)
            }, x.fitWidth = function(t, e) {
                return Go(x, t, e)
            }, x.fitHeight = function(t, e) {
                return Uo(x, t, e)
            },
            function() {
                return e = t.apply(this, arguments), x.invert = e.invert && N, A()
            }
    }((function() {
        return t
    }))()
...
function Yo() {
    return function(t) {
        ...
        return o.scale = function(t) {
            ...
            return arguments.length ? (null == t ? l = e = n = r = null : (l = +t[0][0], e = +t[0][1], n = +t[1][0], r = +t[1][1]), p()) : null == l ? null : [
                [l, e],
                [n, r]
            ]
        }, p()
    ...
    (new t).launches().then((t => {
        ...
        function() {
            const t = 640,
                ...
                r = Ft("#map").append("svg").attr("width", t + n.left + n.right).attr("height", e + n.top + n.bottom).append("g").attr("transform", "translate(" + n.left + "," + n.top + ")"),
                o = Yo().scale(70).center([0, 20]).translate([t / 2 - n.left, e / 2]);
            r.append("g").selectAll("path").data(Vo.features).enter().append("path").attr("class", "topo").attr("d", function(t, e) {
                var n, r, o = 4.5;

                function i(t) {
                    return t && ("function" == typeof o && r.pointRadius(+o.apply(this, arguments)), In(t, n(r))), r.result()
                }
                return i.area = function(t) {
                    return In(t, n(hr)), hr.result()
                }, i.measure = function(t) {
                    return In(t, n(to)), to.result()
                }, i.bounds = function(t) {
                    return In(t, n(br)), br.result()
                }, i.centroid = function(t) {
                    return In(t, n(qr)), qr.result()
                }, i.projection = function(e) {
                    return arguments.length ? (n = null == e ? (t = null, kn) : (t = e).stream, i) : t
                }, i.context = function(t) {
                    return arguments.length ? (r = null == t ? (e = null, new eo) : new jr(e = t), "function" != typeof o && r.pointRadius(o), i) : e
                }, i.pointRadius = function(t) {
                    return arguments.length ? (o = "function" == typeof t ? t : (r.pointRadius(+t), +t), i) : o
                }, i.projection(t).context(e)
            }().projection(o)).attr("fill", (function(t) {
                return colorScale(0)
            })).style("opacity", .7)
        }()
    }))
